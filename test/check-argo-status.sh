...
#kubectl logs --follow --pod-running-timeout 30m workflow/$ARGO_WORKFLOW #Currently we cannot use kubectl for Workflow. See https://github.com/argoproj/argo/issues/1108
